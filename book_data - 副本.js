...
const bookData = {
    ...
    // 推荐新书 - 使用前8张图片
    recommendedNewBooks: [
        { id: 1, title: 'Building Web APIs with ASP.NET Core', author: '作者A', description: '...', cover: '5204s.jpeg', rating: 4.8, views: '12.5万' },
        { id: 2, title: 'AI for Everyday IT', author: '作者B', description: '...', cover: '5205s.jpeg', rating: 4.7, views: '10.8万' },
        { id: 3, title: 'Redis设计与实现', author: '作者C', description: '...', cover: '5206s.jpeg', rating: 4.6, views: '9.2万' },
        { id: 4, title: 'Redis入门指南（第2版）', author: '作者D', description: '...', cover: '5207s.jpeg', rating: 4.5, views: '8.7万' },
        { id: 5, title: 'Redis开发与运维', author: '作者E', description: '...', cover: '5208s.jpeg', rating: 4.4, views: '7.9万' },
        { id: 6, title: 'React快速上手开发', author: '作者F', description: '...', cover: '5209s.jpeg', rating: 4.3, views: '7.2万' },
        { id: 7, title: 'RabbitMQ实战指南', author: '作者G', description: '...', cover: '5210s.jpeg', rating: 4.2, views: '6.8万' },
        { id: 8, title: 'Python自动化运维：技术与最佳实践', author: '作者H', description: '...', cover: '5211s.jpeg', rating: 4.1, views: '6.3万' }
    ],
    // 言情好文 - 使用中间4张图片
    romanceBooks: [
        { id: 9, title: 'Python学习手册(第4版)', author: '作者I', description: '...', cover: '5212s.jpeg', rating: 4.0, views: '5.9万' },
        { id: 10, title: 'The Quick Python Book 4th Edition', author: '作者J', description: '...', cover: '5213s.jpeg', rating: 3.9, views: '5.5万' },
        { id: 11, title: 'Terraform in Depth', author: '作者K', description: '...', cover: '5214s.jpeg', rating: 3.8, views: '5.1万' },
        { id: 12, title: 'Machine Learning for Tabular Data', author: '作者L', description: '...', cover: '5215s.jpeg', rating: 3.7, views: '4.8万' }
    ],
    // 原创畅读 - 使用最后2张图片，避免重复
    originalBooks: [
        { id: 13, title: 'Learn SQL in a Month of Lunches', author: '作者M', description: '...', cover: '5216s.jpeg', rating: 3.6, views: '4.5万' },
        { id: 14, title: 'Graph Neural Networks in Action', author: '作者N', description: '...', cover: '5217s.jpeg', rating: 3.5, views: '4.2万' },
        { id: 15, title: 'Go in Practice 2nd Edition', author: '作者O', description: '...', cover: '5204s.jpeg', rating: 3.4, views: '3.9万' },
        { id: 16, title: 'Effective Data Analysis', author: '作者P', description: '...', cover: '5205s.jpeg', rating: 3.3, views: '3.6万' }
    ],
    allBooks: [
